  ...
  const features = [
    {
      icon: "✍️",
      title: "Rich Editor",
      desc: "Create beautiful posts with our intuitive editor",
    },
    {
      icon: "📸",
      title: "Photo Stories",
      desc: "Share moments through stunning visuals",
    },
    {
      icon: "💬",
      title: "Engage",
      desc: "Connect through comments and reactions",
    },
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-16 md:pb-32">
          ...
          <div className="text-center mb-16 md:mb-32">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black mb-6 leading-tight tracking-tight">
              ...
              <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent inline-block hover:scale-110 transition-transform cursor-default">
                Voice
              </span>
              <br className="hidden md:block" />{" "}
              {/* Break line differently on mobile vs desktop */}
              <span className="inline-block hover:scale-110 transition-transform cursor-default">
                {" "}
                Amplified
              </span>
            ...
            <p className="text-lg md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8 md:mb-12 leading-relaxed px-2">
              Create, share, and discover stories that matter. Build your
              audience and connect with readers who care.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mb-16">
              <Link href="/register" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto text-lg h-14 md:h-16 px-10 group relative overflow-hidden cursor-pointer"
                >
              ...
              <Link href="/explore" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto text-lg h-14 md:h-16 px-10 bg-white/5 backdrop-blur-sm border-white/30 hover:bg-white hover:text-black cursor-pointer"
                >
                  Explore Stories
                </Button>
              </Link>
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 p-8 md:p-16 text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Join thousands of writers who are already building their
                audience on Blogify.
              </p>
              <Link
                href="/register"
              ...
              >
                <Button
                  size="lg"
                  className="w-full sm:w-auto text-lg h-14 md:h-16 px-12 bg-black hover:bg-gray-900 text-white border-2 border-white/20"
                >
                  Get Started Free
                </Button>
              </Link>
        ...
        <footer className="border-t border-white/10 py-8 md:py-12 text-center text-gray-400 text-sm md:text-base">
          <p>
            © {new Date().getFullYear()} Blogify. Made with heart for creators.
          </p>
        </footer>
      </div>
    </div>
